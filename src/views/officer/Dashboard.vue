<template>
  <div >
      <div class="w-screen flex md:hidden bg-black h-screen fixed top-0 z-50">
 ...
 <div class="flex overflow-auto pr-14 pl-8 ease-in-out duration-300 " :class="showSidebar ? ' md:pr-64  ' : '  md:pr-28'">
        <div :class="showSidebar ? 'w-screen h-screen '  : 'w-full  h-screen '  ">
          ...
          <div class="flex w-full mt-10 pt-5 gap-5">
              <div @click="pending" class=" cursor-pointer bg-brand-omajor w-1/4 rounded flex p-5 content-center justify-center">
                <div class="w-1/3">
                ...
                <div class="w-2/3">
                    <h2 class="text-center text-5xl "  > {{ dashB.pending }} </h2> 
                    <h4 class="text-sm text-center">Pending</h4>
                </div>
                <img v-if="active == 'pending'" src="../../assets/images/icons/active.svg" alt="" class=" w-5 md:m-0 mx-auto cursor-pointer "> 
              </div>
               <div  @click="document" class="cursor-pointer bg-brand-omajor w-1/4 rounded flex p-5 content-center justify-center">
                <div class="w-1/3">
                        <svg width="62" height="62" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 20.5C26.3125 20.5 31.4286 15.9115 31.4286 10.25C31.4286 4.58848 26.3125 0 20 0C13.6875 0 8.57143 4.58848 8.57143 10.25C8.57143 15.9115 13.6875 20.5 20 20.5ZM28.5536 23.1105L24.2857 38.4375L21.4286 27.5469L24.2857 23.0625H15.7143L18.5714 27.5469L15.7143 38.4375L11.4464 23.1105C5.08036 23.3828 0 28.0514 0 33.825V37.1562C0 39.2783 1.91964 41 4.28571 41H35.7143C38.0804 41 40 39.2783 40 37.1562V33.825C40 28.0514 34.9196 23.3828 28.5536 23.1105Z" fill="white"/>
                    </svg>
                ...
                <div class="w-2/3">
                    <h2 class="text-center text-5xl "  > {{ dashB.document }} </h2> 
                    <h4 class="text-sm text-center">Documents</h4>
                </div>
                <img  v-if="active == 'document'"  src="../../assets/images/icons/active.svg" alt="" class=" w-5 md:m-0 mx-auto cursor-pointer "> 
              </div>
               <div @click="applied"  class="cursor-pointer bg-brand-omajor w-1/4 rounded flex p-5 content-center justify-center">
                <div class="w-1/3">
                        <svg width="62" height="62" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 20.5C26.3125 20.5 31.4286 15.9115 31.4286 10.25C31.4286 4.58848 26.3125 0 20 0C13.6875 0 8.57143 4.58848 8.57143 10.25C8.57143 15.9115 13.6875 20.5 20 20.5ZM28.5536 23.1105L24.2857 38.4375L21.4286 27.5469L24.2857 23.0625H15.7143L18.5714 27.5469L15.7143 38.4375L11.4464 23.1105C5.08036 23.3828 0 28.0514 0 33.825V37.1562C0 39.2783 1.91964 41 4.28571 41H35.7143C38.0804 41 40 39.2783 40 37.1562V33.825C40 28.0514 34.9196 23.3828 28.5536 23.1105Z" fill="white"/>
                    </svg>
                ...
                <div class="w-2/3">
                    <h2 class="text-center text-5xl "  > {{ dashB.applied }} </h2> 
                    <h4 class="text-sm text-center">Applied</h4>
                </div>
                <img  v-if="active == 'applied'"  src="../../assets/images/icons/active.svg" alt="" class=" w-5 md:m-0 mx-auto cursor-pointer "> 
              </div>
                <div @click="success"  class="cursor-pointer bg-brand-omajor w-1/4 rounded flex p-5 content-center justify-center">
                <div class="w-1/3">
                    <svg width="62" height="62" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 20.5C26.3125 20.5 31.4286 15.9115 31.4286 10.25C31.4286 4.58848 26.3125 0 20 0C13.6875 0 8.57143 4.58848 8.57143 10.25C8.57143 15.9115 13.6875 20.5 20 20.5ZM28.5536 23.1105L24.2857 38.4375L21.4286 27.5469L24.2857 23.0625H15.7143L18.5714 27.5469L15.7143 38.4375L11.4464 23.1105C5.08036 23.3828 0 28.0514 0 33.825V37.1562C0 39.2783 1.91964 41 4.28571 41H35.7143C38.0804 41 40 39.2783 40 37.1562V33.825C40 28.0514 34.9196 23.3828 28.5536 23.1105Z" fill="white"/>
                    </svg>
                ...
                <div class="w-2/3">
                    <h2 class="text-center text-5xl "  > {{ dashB.success }} </h2> 
                    <h4 class="text-sm text-center">Successfull</h4>
                </div>
                <img  v-if="active == 'success'"  src="../../assets/images/icons/active.svg" alt="" class=" w-5 md:m-0 mx-auto cursor-pointer "> 
              </div>
          </div>
      ...
      <div class="w-full mt-10" v-if="!Client.exists()">
          <h1 class="w-full text-2xl text-center text-gray-500">No clients yet </h1>
            ...
            <template v-for="m in Client.all()" :key="m.id">
                  <div class="w-full flex py-3  border-b border-brand-omajor mb-8">
                    <div class="w-1/6">
                    ...
                    <div class="w-1/6">
                    <h5 class="text-center">{{ application_stats( m.applications_status ) }}</h5>
                    </div>
                    <div class="w-1/6">
...
import {  application_stats  } from '../../utils'
...
export default {
    ...
    unmounted(){
     ...
     setup(){
       let serachInput = ref('')
        let dashB = ref("");
        AdmissionOfficer.api().dashboard().then( res => {
          dashB.value = res
        })
        ...
        const pending = () => {
          ...
          AdmissionOfficer.api().allclients('pending')
        }
        const document = () => {
          active.value = 'document'
          AdmissionOfficer.api().allclients('document')
        }
        const applied = () => {
          active.value = 'applied'
          AdmissionOfficer.api().allclients('applied')
        }
        const success = () => {
          active.value = 'success'
          AdmissionOfficer.api().allclients('success')
        }
        const search = () => {
          console.log("Searchin", serachInput.value.length > 3)
          if(serachInput.value.length  > 3){
            active.value = false
            console.log("Searchin jjh")
            AdmissionOfficer.api().allclients(serachInput.value, "search")
          }
          if(serachInput.value.length < 1)
            active.value = false
            AdmissionOfficer.api().allclients()
          }
        return {
